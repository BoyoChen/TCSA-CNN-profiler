...
# ------------
# Based on profiler_3_1
# use arcsin to calculate R34 bease on profile
# ------------
...
class Model(tf.keras.Model):
    ...
    def calculate_from_profile(self, pred_profile):
        ...
        calibration = self.calibrate_factor * tf.stop_gradient(finite_value) + self.calibrate_constant
